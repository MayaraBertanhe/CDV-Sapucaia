...
│   ├── BEAST/
│   │   ├── strict
│   │       └── BEAST XML files and log files for strict molecular-clock analyses, including traits and general logs. Also includes the     │   │            combined strict-clock trees and log file used for the TreeAnnotator analysis.  
│   │
│   ├── TreeTime/
